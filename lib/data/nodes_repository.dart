...
import 'package:algorithm/data/astar_algorithm.dart';
import 'package:algorithm/data/breadth_first_search.dart';
import 'package:algorithm/data/depth_first_search.dart';
import 'package:algorithm/data/dijkstras_algorithm.dart';
import 'package:algorithm/data/drunk_algorithm.dart';
import 'package:algorithm/data/visualize_algorithm.dart';
import 'package:algorithm/notifiers/selected_shortest_path_algorithm_state_notifier.dart';
...
abstract class NodesRepository {
  ...
  void setCurrentlySelectedAlgorithmTo(
      {required PathFindingAlgorithmType pathFindingAlgorithmType,
      required int animationTimeDelay});
}

class NodesRepositoryImpl implements NodesRepository {
  late VisualizeAlgorithm _pathFindingAlgorithm =
  ...
  void setCurrentlySelectedAlgorithmTo(
    ...
    final isDiagonalMovementEnabled =
        _pathFindingAlgorithm.isDiagonalMovementEnabled;
